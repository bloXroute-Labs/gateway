...
// sendTxNotificationEthFormat - build a response according to client request and notify client
...
// sendEthSubscribeNotification - build a response according to client request and notify client
