...
func handleGetBlockHeaders(backend Backend, msg Decoder, peer *Peer) error {
	...
	if err == ErrAncientHeaders {
		go func() {
			...
			peer.Log().Debugf("successfully fetched %v ancient headers from blockchain node", len(headersResponse.BlockHeadersRequest))

			err = peer.SendBlockHeaders(headersResponse.BlockHeadersRequest)
			if err != nil {
