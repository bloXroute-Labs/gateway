// Package valset Tendermint leader selection algorithm
//nolint:gofmt
package valset
...
// RescalePriorities changes scaling of priorities
...
// UpdateTotalVotingPower force recalculation of the set's total voting power.
...
func (vals *ValidatorSet) applyUpdates(updates []*Validator) {
	...
	merged := make([]*Validator, uint64(len(existing))+uint64(len(updates)))
	i := 0
...
// UpdateValidatorMap cahnges state of validators map from Validators.
...
// StringIndented implementation of pretty-printing
