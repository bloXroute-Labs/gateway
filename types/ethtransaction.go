...
func NewEthTransaction(h SHA256Hash, rawEthTx *ethtypes.Transaction) (*EthTransaction, error) {
...
func EthTransactionFromBytes(h SHA256Hash, tc TxContent) (*EthTransaction, error) {
	...
	return NewEthTransaction(h, &rawEthTx)
}
