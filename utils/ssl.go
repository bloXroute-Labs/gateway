...
func GetCertDir(registrationOnlyBaseURL, privateBaseURL, certName string) (privateCertFile string, privateKeyFile string, registrationOnlyCertFile string, registrationOnlyKeyFile string) {
	var (
