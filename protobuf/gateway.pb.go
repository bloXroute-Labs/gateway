...
type BlockHeader struct {
	...
	MilliTimestamp   string                 `protobuf:"bytes,22,opt,name=milli_timestamp,json=milliTimestamp,proto3" json:"milli_timestamp,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *BlockHeader) GetMilliTimestamp() string {
	if x != nil {
		return x.MilliTimestamp
	}
	return ""
}
...
func (x *NodeConnStatus) GetConnectionType() string {
	if x != nil {
...
type GatewayInfo struct {
	...
	P2PServers       []string               `protobuf:"bytes,11,rep,name=p2p_servers,json=p2pServers,proto3" json:"p2p_servers,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *GatewayInfo) GetP2PServers() []string {
	if x != nil {
		return x.P2PServers
	}
	return nil
...
type StatusResponse struct {
	...
	Nodes         map[string]*NodeConnStatus `protobuf:"bytes,3,rep,name=nodes,proto3" json:"nodes,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	Relays        map[string]*BDNConnStatus  `protobuf:"bytes,4,rep,name=relays,proto3" json:"relays,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
const file_gateway_proto_rawDesc = "" +
	"\n" +
	"\rgateway.proto\x12\agateway\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\x9f\x02\n" +
	"\x06TxLogs\x12\x18\n" +
	...
	"\x11transaction_index\x18\x06 \x01(\tR\x10transactionIndex\x12\x1d\n" +
	"\n" +
	"block_hash\x18\a \x01(\tR\tblockHash\x12\x1b\n" +
	"\tlog_index\x18\b \x01(\tR\blogIndex\x12\x18\n" +
	"\aremoved\x18\t \x01(\bR\aremoved\"T\n" +
	"\x11TxReceiptsRequest\x12\x1a\n" +
	"\bincludes\x18\x01 \x03(\tR\bincludes\x12#\n" +
	"\vauth_header\x18\x02 \x01(\tB\x02\x18\x01R\n" +
	"authHeader\"\xca\x04\n" +
	"\x0fTxReceiptsReply\x12\x1d\n" +
	"\n" +
	...
	"\x13cumulative_gas_used\x18\x04 \x01(\tR\x11cumulativeGasUsed\x12,\n" +
	"\x12effective_gas_used\x18\x05 \x01(\tR\x10effectiveGasUsed\x12\x12\n" +
	"\x04from\x18\x06 \x01(\tR\x04from\x12\x19\n" +
	"\bgas_used\x18\a \x01(\tR\agasUsed\x12#\n" +
	"\x04logs\x18\b \x03(\v2\x0f.gateway.TxLogsR\x04logs\x12\x1d\n" +
	"\n" +
	"logs_bloom\x18\t \x01(\tR\tlogsBloom\x12\x16\n" +
	"\x06status\x18\n" +
	" \x01(\tR\x06status\x12\x0e\n" +
	"\x02to\x18\v \x01(\tR\x02to\x12)\n" +
	"\x10transaction_hash\x18\f \x01(\tR\x0ftransactionHash\x12+\n" +
	"\x11transaction_index\x18\r \x01(\tR\x10transactionIndex\x12\x12\n" +
	"\x04type\x18\x0e \x01(\tR\x04type\x12\x1b\n" +
	"\ttxs_count\x18\x0f \x01(\tR\btxsCount\x12\"\n" +
	"\rblob_gas_used\x18\x10 \x01(\tR\vblobGasUsed\x12$\n" +
	"\x0eblob_gas_price\x18\x11 \x01(\tR\fblobGasPrice\"\x80\x01\n" +
	"\n" +
	"CallParams\x127\n" +
	"\x06params\x18\x01 \x03(\v2\x1f.gateway.CallParams.ParamsEntryR\x06params\x1a9\n" +
	"\vParamsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\x8a\x01\n" +
	"\x11EthOnBlockRequest\x12\x1a\n" +
	"\bincludes\x18\x01 \x03(\tR\bincludes\x124\n" +
	"\vcall_params\x18\x02 \x03(\v2\x13.gateway.CallParamsR\n" +
	"callParams\x12#\n" +
	"\vauth_header\x18\x03 \x01(\tB\x02\x18\x01R\n" +
	"authHeader\"u\n" +
	"\x0fEthOnBlockReply\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1a\n" +
	"\bresponse\x18\x02 \x01(\tR\bresponse\x12 \n" +
	"\vblockHeight\x18\x03 \x01(\tR\vblockHeight\x12\x10\n" +
	"\x03tag\x18\x04 \x01(\tR\x03tag\"g\n" +
	"\n" +
	"TxsRequest\x12\x18\n" +
	"\afilters\x18\x01 \x01(\tR\afilters\x12\x1a\n" +
	"\bincludes\x18\x02 \x03(\tR\bincludes\x12#\n" +
	"\vauth_header\x18\x03 \x01(\tB\x02\x18\x01R\n" +
	"authHeader\"f\n" +
	"\x02Tx\x12\x12\n" +
	"\x04from\x18\f \x01(\fR\x04from\x12!\n" +
	"\flocal_region\x18\x0e \x01(\bR\vlocalRegion\x12\x12\n" +
	"\x04time\x18\x0f \x01(\x03R\x04time\x12\x15\n" +
	"\x06raw_tx\x18\x10 \x01(\fR\x05rawTx\"J\n" +
	...
	"\vauth_header\x18\x02 \x01(\tB\x02\x18\x01R\n" +
	"authHeader\x128\n" +
	"\tparsedTxs\x18\x03 \x01(\v2\x1a.google.protobuf.BoolValueR\tparsedTxs\"\xef\x05\n" +
	"\vBlockHeader\x12\x1f\n" +
	"\vparent_hash\x18\x01 \x01(\tR\n" +
	"parentHash\x12\x1f\n" +
	"\vsha3_uncles\x18\x02 \x01(\tR\n" +
	"sha3Uncles\x12\x14\n" +
	"\x05miner\x18\x03 \x01(\tR\x05miner\x12\x1d\n" +
	"\n" +
	"state_root\x18\x04 \x01(\tR\tstateRoot\x12+\n" +
	"\x11transactions_root\x18\x05 \x01(\tR\x10transactionsRoot\x12#\n" +
	"\rreceipts_root\x18\x06 \x01(\tR\freceiptsRoot\x12\x1d\n" +
	"\n" +
	"logs_bloom\x18\a \x01(\tR\tlogsBloom\x12\x1e\n" +
	"\n" +
	"difficulty\x18\b \x01(\tR\n" +
	"difficulty\x12\x16\n" +
	"\x06number\x18\t \x01(\tR\x06number\x12\x1b\n" +
	"\tgas_limit\x18\n" +
	" \x01(\tR\bgasLimit\x12\x19\n" +
	"\bgas_used\x18\v \x01(\tR\agasUsed\x12\x1c\n" +
	"\ttimestamp\x18\f \x01(\tR\ttimestamp\x12\x1d\n" +
	"\n" +
	"extra_data\x18\r \x01(\tR\textraData\x12\x19\n" +
	"\bmix_hash\x18\x0e \x01(\tR\amixHash\x12\x14\n" +
	"\x05nonce\x18\x0f \x01(\tR\x05nonce\x12'\n" +
	"\x10base_fee_per_gas\x18\x10 \x01(\tR\rbaseFeePerGas\x12)\n" +
	"\x10withdrawals_root\x18\x11 \x01(\tR\x0fwithdrawalsRoot\x12\"\n" +
	"\rblob_gas_used\x18\x12 \x01(\tR\vblobGasUsed\x12&\n" +
	"\x0fexcess_blob_gas\x18\x13 \x01(\tR\rexcessBlobGas\x12,\n" +
	"\x12parent_beacon_root\x18\x14 \x01(\tR\x10parentBeaconRoot\x12#\n" +
	"\rrequests_hash\x18\x15 \x01(\tR\frequestsHash\x12'\n" +
	"\x0fmilli_timestamp\x18\x16 \x01(\tR\x0emilliTimestamp\"u\n" +
	"\x13FutureValidatorInfo\x12!\n" +
	"\fblock_height\x18\x01 \x01(\tR\vblockHeight\x12\x1b\n" +
	"\twallet_id\x18\x02 \x01(\tR\bwalletId\x12\x1e\n" +
	"\n" +
	"accessible\x18\x03 \x01(\tR\n" +
	"accessible\"}\n" +
	"\n" +
	"Withdrawal\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\x12\x16\n" +
	...
	"\x0fvalidator_index\x18\x04 \x01(\tR\x0evalidatorIndex\"\xb3\x02\n" +
	"\vBlocksReply\x12\x12\n" +
	"\x04hash\x18\x01 \x01(\tR\x04hash\x12*\n" +
	"\x0esubscriptionID\x18\x02 \x01(\tB\x02\x18\x01R\x0esubscriptionID\x12,\n" +
	"\x06header\x18\x03 \x01(\v2\x14.gateway.BlockHeaderR\x06header\x12P\n" +
	"\x15future_validator_info\x18\x04 \x03(\v2\x1c.gateway.FutureValidatorInfoR\x13futureValidatorInfo\x12-\n" +
	"\vtransaction\x18\x05 \x03(\v2\v.gateway.TxR\vtransaction\x125\n" +
	"\vwithdrawals\x18\x06 \x03(\v2\x13.gateway.WithdrawalR\vwithdrawals\"\x98\x01\n" +
	"\x1cDisconnectInboundPeerRequest\x12\x17\n" +
	"\apeer_ip\x18\x01 \x01(\tR\x06peerIp\x12\x1b\n" +
	"\tpeer_port\x18\x02 \x01(\x03R\bpeerPort\x12\x1d\n" +
	"\n" +
	"public_key\x18\x03 \x01(\tR\tpublicKey\x12#\n" +
	"\vauth_header\x18\x04 \x01(\tB\x02\x18\x01R\n" +
	"authHeader\"4\n" +
	"\x1aDisconnectInboundPeerReply\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\";\n" +
	"\x14SubscriptionsRequest\x12#\n" +
	...
	"\tfeed_name\x18\x03 \x01(\tR\bfeedName\x12\x18\n" +
	"\anetwork\x18\x04 \x01(\rR\anetwork\x12\x1f\n" +
	"\vremote_addr\x18\x05 \x01(\tR\n" +
	"remoteAddr\x12\x18\n" +
	"\ainclude\x18\x06 \x01(\tR\ainclude\x12\x16\n" +
	"\x06filter\x18\a \x01(\tR\x06filter\x12\x10\n" +
	"\x03age\x18\b \x01(\x04R\x03age\x12#\n" +
	"\rmessages_sent\x18\t \x01(\x04R\fmessagesSent\x12\x1b\n" +
	"\tconn_type\x18\n" +
	" \x01(\tR\bconnType\"Q\n" +
	"\x12SubscriptionsReply\x12;\n" +
	"\rsubscriptions\x18\x01 \x03(\v2\x15.gateway.SubscriptionR\rsubscriptions\"5\n" +
	...
	"\n" +
	"build_date\x18\x02 \x01(\tR\tbuildDate\"2\n" +
	"\vStopRequest\x12#\n" +
	"\vauth_header\x18\x01 \x01(\tB\x02\x18\x01R\n" +
	"authHeader\"\v\n" +
	"\tStopReply\"G\n" +
	"\fPeersRequest\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12#\n" +
	"\vauth_header\x18\x02 \x01(\tB\x02\x18\x01R\n" +
	"authHeader\"`\n" +
	"\fRateSnapshot\x12\x1e\n" +
	"\n" +
	"fiveMinute\x18\x01 \x01(\x03R\n" +
	"fiveMinute\x12\x18\n" +
	"\aoneHour\x18\x02 \x01(\x03R\aoneHour\x12\x16\n" +
	"\x06oneDay\x18\x03 \x01(\x03R\x06oneDay\"\xf6\b\n" +
	"\x04Peer\x12\x0e\n" +
	"\x02ip\x18\x01 \x01(\tR\x02ip\x12\x17\n" +
	"\anode_id\x18\x02 \x01(\tR\x06nodeId\x12\x12\n" +
	"\x04type\x18\x03 \x01(\tR\x04type\x12\x14\n" +
	"\x05state\x18\x04 \x01(\tR\x05state\x12\x18\n" +
	"\anetwork\x18\x05 \x01(\rR\anetwork\x128\n" +
	"\tinitiator\x18\x06 \x01(\v2\x1a.google.protobuf.BoolValueR\tinitiator\x12'\n" +
	"\x10min_us_from_peer\x18\a \x01(\x03R\rminUsFromPeer\x12#\n" +
	"\x0emin_us_to_peer\x18\b \x01(\x03R\vminUsToPeer\x12,\n" +
	"\x12slow_traffic_count\x18\t \x01(\x03R\x10slowTrafficCount\x12)\n" +
	"\x11min_us_round_trip\x18\n" +
	" \x01(\x03R\x0eminUsRoundTrip\x12\x1d\n" +
	"\n" +
	"account_id\x18\v \x01(\tR\taccountId\x12!\n" +
	"\faccount_tier\x18\f \x01(\tR\vaccountTier\x12\x12\n" +
	"\x04port\x18\r \x01(\x03R\x04port\x126\n" +
	"\bdisabled\x18\x0e \x01(\v2\x1a.google.protobuf.BoolValueR\bdisabled\x12\x1b\n" +
	"\tmev_miner\x18\x0f \x01(\tR\bmevMiner\x12\x1f\n" +
	"\vmev_builder\x18\x10 \x01(\tR\n" +
	"mevBuilder\x12\x1e\n" +
	"\n" +
	"capability\x18\x11 \x01(\rR\n" +
	"capability\x121\n" +
	"\x15unpaid_tx_burst_limit\x18\x12 \x01(\x03R\x12unpaidTxBurstLimit\x12-\n" +
	"\x13paid_tx_burst_limit\x18\x13 \x01(\x03R\x10paidTxBurstLimit\x12U\n" +
	"\x1cunpaid_tx_burst_limit_excess\x18\x14 \x01(\v2\x15.gateway.RateSnapshotR\x18unpaidTxBurstLimitExcess\x12Q\n" +
	"\x1apaid_tx_burst_limit_excess\x18\x15 \x01(\v2\x15.gateway.RateSnapshotR\x16paidTxBurstLimitExcess\x12C\n" +
	"\x12paid_tx_throughput\x18\x16 \x01(\v2\x15.gateway.RateSnapshotR\x10paidTxThroughput\x12G\n" +
	"\x14unpaid_tx_throughput\x18\x17 \x01(\v2\x15.gateway.RateSnapshotR\x12unpaidTxThroughput\x12\x18\n" +
	"\atrusted\x18\x18 \x01(\tR\atrusted\x12!\n" +
	"\fmev_builders\x18\x19 \x03(\tR\vmevBuilders\x12\x17\n" +
	"\anew_txs\x18\x1a \x01(\x03R\x06newTxs\x12(\n" +
	"\x10already_seen_txs\x18\x1b \x01(\x03R\x0ealreadySeenTxs\x12\x1a\n" +
	"\bprotocol\x18\x1c \x01(\rR\bprotocol\"1\n" +
	"\n" +
	"PeersReply\x12#\n" +
	"\x05peers\x18\x01 \x03(\v2\r.gateway.PeerR\x05peers\"\x0f\n" +
	"\rSendTXRequest\"'\n" +
	"\vTransaction\x12\x18\n" +
	"\acontent\x18\x01 \x01(\tR\acontent\"H\n" +
	"\fTransactions\x128\n" +
	"\ftransactions\x18\x01 \x03(\v2\x14.gateway.TransactionR\ftransactions\"w\n" +
	"\rBxTransaction\x12\x12\n" +
	"\x04hash\x18\x01 \x01(\tR\x04hash\x12\x1b\n" +
	"\tshort_ids\x18\x02 \x03(\x04R\bshortIds\x125\n" +
	"\badd_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\aaddTime\"-\n" +
	"\x17GetBxTransactionRequest\x12\x12\n" +
	"\x04hash\x18\x01 \x01(\tR\x04hash\"B\n" +
	"\x18GetBxTransactionResponse\x12&\n" +
	...
	"\aTxIndex\x12\x10\n" +
	"\x03idx\x18\x01 \x01(\x05R\x03idx\x12\x17\n" +
	"\atx_hash\x18\x02 \x01(\tR\x06txHash\"4\n" +
	"\n" +
	"ErrorIndex\x12\x10\n" +
	"\x03idx\x18\x01 \x01(\x05R\x03idx\x12\x14\n" +
	"\x05error\x18\x02 \x01(\tR\x05error\"s\n" +
	"\x10BlxrBatchTXReply\x12-\n" +
	"\ttx_hashes\x18\x01 \x03(\v2\x10.gateway.TxIndexR\btxHashes\x120\n" +
	"\ttx_errors\x18\x02 \x03(\v2\x13.gateway.ErrorIndexR\btxErrors\"4\n" +
	"\rStatusRequest\x12#\n" +
	"\vauth_header\x18\x01 \x01(\tB\x02\x18\x01R\n" +
	"authHeader\"M\n" +
	...
	"expireDate\"\xfd\x04\n" +
	"\x0fNodePerformance\x12\x14\n" +
	"\x05since\x18\x01 \x01(\tR\x05since\x12U\n" +
	"(new_blocks_received_from_blockchain_node\x18\x02 \x01(\rR#newBlocksReceivedFromBlockchainNode\x12>\n" +
	"\x1cnew_blocks_received_from_bdn\x18\x03 \x01(\rR\x18newBlocksReceivedFromBdn\x12&\n" +
	"\x0fnew_blocks_seen\x18\x04 \x01(\rR\rnewBlocksSeen\x12S\n" +
	"'new_block_messages_from_blockchain_node\x18\x05 \x01(\rR\"newBlockMessagesFromBlockchainNode\x12]\n" +
	",new_block_announcements_from_blockchain_node\x18\x06 \x01(\rR'newBlockAnnouncementsFromBlockchainNode\x12M\n" +
	"$new_tx_received_from_blockchain_node\x18\a \x01(\rR\x1fnewTxReceivedFromBlockchainNode\x126\n" +
	"\x18new_tx_received_from_bdn\x18\b \x01(\rR\x14newTxReceivedFromBdn\x12%\n" +
	"\x0ftx_sent_to_node\x18\t \x01(\rR\ftxSentToNode\x123\n" +
	"\x16duplicate_tx_from_node\x18\n" +
	" \x01(\rR\x13duplicateTxFromNode\"d\n" +
	"\fWsConnStatus\x12\x12\n" +
	"\x04addr\x18\x01 \x01(\tR\x04addr\x12\x1f\n" +
	"\vconn_status\x18\x02 \x01(\tR\n" +
	"connStatus\x12\x1f\n" +
	"\vsync_status\x18\x03 \x01(\tR\n" +
	"syncStatus\"\x99\x03\n" +
	"\x0eNodeConnStatus\x12\x1f\n" +
	"\vconn_status\x18\x01 \x01(\tR\n" +
	"connStatus\x12:\n" +
	"\rws_connection\x18\x02 \x01(\v2\x15.gateway.WsConnStatusR\fwsConnection\x12C\n" +
	"\x10node_performance\x18\x03 \x01(\v2\x18.gateway.NodePerformanceR\x0fnodePerformance\x12\x18\n" +
	"\aInbound\x18\x04 \x01(\bR\aInbound\x12 \n" +
	"\vIsConnected\x18\x05 \x01(\bR\vIsConnected\x12\x18\n" +
	"\aDynamic\x18\x06 \x01(\bR\aDynamic\x12\x18\n" +
	"\aVersion\x18\a \x01(\x03R\aVersion\x12\x12\n" +
	"\x04Name\x18\b \x01(\tR\x04Name\x12 \n" +
	"\vConnectedAt\x18\t \x01(\tR\vConnectedAt\x12\x16\n" +
	"\x06PeerId\x18\n" +
	" \x01(\tR\x06PeerId\x12'\n" +
	"\x0fconnection_type\x18\v \x01(\tR\x0econnectionType\"\x80\x01\n" +
	"\rBDNConnStatus\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12!\n" +
	"\fconnected_at\x18\x02 \x01(\tR\vconnectedAt\x124\n" +
	"\alatency\x18\x03 \x01(\v2\x1a.gateway.ConnectionLatencyR\alatency\"\xba\x01\n" +
	"\x11ConnectionLatency\x12'\n" +
	"\x10min_ms_from_peer\x18\a \x01(\x03R\rminMsFromPeer\x12#\n" +
	"\x0emin_ms_to_peer\x18\b \x01(\x03R\vminMsToPeer\x12,\n" +
	"\x12slow_traffic_count\x18\t \x01(\x03R\x10slowTrafficCount\x12)\n" +
	"\x11min_ms_round_trip\x18\n" +
	" \x01(\x03R\x0eminMsRoundTrip\"\xef\x02\n" +
	"\vGatewayInfo\x12\x18\n" +
	"\aversion\x18\x01 \x01(\tR\aversion\x12\x17\n" +
	"\anode_id\x18\x02 \x01(\tR\x06nodeId\x12\x1d\n" +
	"\n" +
	"ip_address\x18\x03 \x01(\tR\tipAddress\x12!\n" +
	"\ftime_started\x18\x04 \x01(\tR\vtimeStarted\x12\x1c\n" +
	"\tcontinent\x18\x05 \x01(\tR\tcontinent\x12\x18\n" +
	"\acountry\x18\x06 \x01(\tR\acountry\x12\x18\n" +
	"\anetwork\x18\b \x01(\tR\anetwork\x12%\n" +
	"\x0estartup_params\x18\a \x01(\tR\rstartupParams\x12,\n" +
	"\x12gateway_public_key\x18\t \x01(\tR\x10gatewayPublicKey\x12#\n" +
	"\rtrusted_peers\x18\n" +
	" \x03(\tR\ftrustedPeers\x12\x1f\n" +
	"\vp2p_servers\x18\v \x03(\tR\n" +
	"p2pServers\"\x9f\x03\n" +
	"\x0eStatusResponse\x127\n" +
	"\fgateway_info\x18\x02 \x01(\v2\x14.gateway.GatewayInfoR\vgatewayInfo\x128\n" +
	"\x05nodes\x18\x03 \x03(\v2\".gateway.StatusResponse.NodesEntryR\x05nodes\x12;\n" +
	"\x06relays\x18\x04 \x03(\v2#.gateway.StatusResponse.RelaysEntryR\x06relays\x127\n" +
	"\faccount_info\x18\x01 \x01(\v2\x14.gateway.AccountInfoR\vaccountInfo\x1aQ\n" +
	"\n" +
	"NodesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12-\n" +
	"\x05value\x18\x02 \x01(\v2\x17.gateway.NodeConnStatusR\x05value:\x028\x01\x1aQ\n" +
	"\vRelaysEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12,\n" +
	"\x05value\x18\x02 \x01(\v2\x16.gateway.BDNConnStatusR\x05value:\x028\x01\"\x8e\x01\n" +
	"\bTxResult\x12\x16\n" +
	"\x06txHash\x18\x01 \x01(\tR\x06txHash\x12\x1e\n" +
	"\n" +
	"txContents\x18\x02 \x01(\tR\n" +
	"txContents\x12 \n" +
	"\vlocalRegion\x18\x03 \x01(\bR\vlocalRegion\x12\x12\n" +
	"\x04time\x18\x04 \x01(\tR\x04time\x12\x14\n" +
	"\x05rawTx\x18\x05 \x01(\tR\x05rawTx\"y\n" +
	"\x12ShortIDListRequest\x12#\n" +
	"\vauth_header\x18\x01 \x01(\tB\x02\x18\x01R\n" +
	"authHeader\x12\x1a\n" +
	"\bshortIDs\x18\x02 \x03(\rR\bshortIDs\x12\"\n" +
	"\fwithSidecars\x18\x03 \x01(\bR\fwithSidecars\"\x1f\n" +
	"\vTxListReply\x12\x10\n" +
	"\x03txs\x18\x01 \x03(\fR\x03txs\".\n" +
	"\x0fShortIDsRequest\x12\x1b\n" +
	"\ttx_hashes\x18\x01 \x03(\fR\btxHashes\",\n" +
	"\rShortIDsReply\x12\x1b\n" +
	"\tshort_ids\x18\x01 \x03(\rR\bshortIds\"\xb8\x03\n" +
	"\x14ProposedBlockRequest\x124\n" +
	"\x16validator_http_address\x18\x01 \x01(\tR\x14validatorHttpAddress\x12\x1c\n" +
	"\tnamespace\x18\x02 \x01(\tR\tnamespace\x12!\n" +
	"\fblock_number\x18\x03 \x01(\x04R\vblockNumber\x12&\n" +
	"\x0fprev_block_hash\x18\x04 \x01(\tR\rprevBlockHash\x12!\n" +
	"\fblock_reward\x18\x05 \x01(\tR\vblockReward\x12\x1b\n" +
	"\tgas_limit\x18\x06 \x01(\x04R\bgasLimit\x12\x19\n" +
	"\bgas_used\x18\a \x01(\x04R\agasUsed\x12-\n" +
	"\apayload\x18\b \x03(\v2\x13.gateway.CompressTxR\apayload\x129\n" +
	"\x19process_blocks_on_gateway\x18\t \x01(\bR\x16processBlocksOnGateway\x12\x0e\n" +
	"\x02id\x18\n" +
	" \x01(\tR\x02id\x12,\n" +
	"\x12un_reverted_hashes\x18\v \x03(\fR\x10unRevertedHashes\"B\n" +
	"\n" +
	"CompressTx\x12\x19\n" +
	"\braw_data\x18\x01 \x01(\fR\arawData\x12\x19\n" +
	"\bshort_id\x18\x02 \x01(\rR\ashortId\"o\n" +
	"\x12ProposedBlockReply\x12'\n" +
	"\x0fvalidator_reply\x18\x01 \x01(\tR\x0evalidatorReply\x120\n" +
	"\x14validator_reply_time\x18\x02 \x01(\x03R\x12validatorReplyTime\">\n" +
	"\x19ProposedBlockStatsRequest\x12!\n" +
	"\fblock_number\x18\x01 \x01(\x04R\vblockNumber\"V\n" +
	"\x17ProposedBlockStatsReply\x12;\n" +
	"\arecords\x18\x01 \x03(\v2!.gateway.ProposedBlockStatsRecordR\arecords\"\xc5\x02\n" +
	"\x18ProposedBlockStatsRecord\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12D\n" +
	"\x10sending_duration\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x0fsendingDuration\x12?\n" +
	"\rreceived_time\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\freceivedTime\x127\n" +
	"\tsent_time\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\bsentTime\x12'\n" +
	"\x0fvalidator_reply\x18\x05 \x01(\tR\x0evalidatorReply\x120\n" +
	"\x14validator_reply_time\x18\x06 \x01(\x03R\x12validatorReplyTime2\xbf\t\n" +
	"\aGateway\x128\n" +
	"\x06BlxrTx\x12\x16.gateway.BlxrTxRequest\x1a\x14.gateway.BlxrTxReply\"\x00\x12G\n" +
	"\vBlxrBatchTX\x12\x1b.gateway.BlxrBatchTXRequest\x1a\x19.gateway.BlxrBatchTXReply\"\x00\x125\n" +
	"\x05Peers\x12\x15.gateway.PeersRequest\x1a\x13.gateway.PeersReply\"\x00\x12B\n" +
	"\x0eTxStoreSummary\x12\x17.gateway.TxStoreRequest\x1a\x15.gateway.TxStoreReply\"\x00\x12N\n" +
	"\x05GetTx\x12 .gateway.GetBxTransactionRequest\x1a!.gateway.GetBxTransactionResponse\"\x00\x122\n" +
	"\x04Stop\x12\x14.gateway.StopRequest\x1a\x12.gateway.StopReply\"\x00\x12;\n" +
	"\aVersion\x12\x17.gateway.VersionRequest\x1a\x15.gateway.VersionReply\"\x00\x12;\n" +
	"\x06Status\x12\x16.gateway.StatusRequest\x1a\x17.gateway.StatusResponse\"\x00\x12M\n" +
	"\rSubscriptions\x12\x1d.gateway.SubscriptionsRequest\x1a\x1b.gateway.SubscriptionsReply\"\x00\x12e\n" +
	"\x15DisconnectInboundPeer\x12%.gateway.DisconnectInboundPeerRequest\x1a#.gateway.DisconnectInboundPeerReply\"\x00\x124\n" +
	"\x06NewTxs\x12\x13.gateway.TxsRequest\x1a\x11.gateway.TxsReply\"\x000\x01\x128\n" +
	"\n" +
	"PendingTxs\x12\x13.gateway.TxsRequest\x1a\x11.gateway.TxsReply\"\x000\x01\x12=\n" +
	"\tNewBlocks\x12\x16.gateway.BlocksRequest\x1a\x14.gateway.BlocksReply\"\x000\x01\x12=\n" +
	"\tBdnBlocks\x12\x16.gateway.BlocksRequest\x1a\x14.gateway.BlocksReply\"\x000\x01\x12F\n" +
	"\n" +
	"EthOnBlock\x12\x1a.gateway.EthOnBlockRequest\x1a\x18.gateway.EthOnBlockReply\"\x000\x01\x12F\n" +
	"\n" +
	"TxReceipts\x12\x1a.gateway.TxReceiptsRequest\x1a\x18.gateway.TxReceiptsReply\"\x000\x01\x12<\n" +
	"\bShortIDs\x12\x18.gateway.ShortIDsRequest\x1a\x16.gateway.ShortIDsReply\x12F\n" +
	"\x0fTxsFromShortIDs\x12\x1b.gateway.ShortIDListRequest\x1a\x14.gateway.TxListReply\"\x00B+Z)github.com/bloXroute-Labs/gateway/gatewayb\x06proto3"
...
var file_gateway_proto_goTypes = []any{
	...
	(*Withdrawal)(nil),                   // 13: gateway.Withdrawal
	(*BlocksReply)(nil),                  // 14: gateway.BlocksReply
	(*DisconnectInboundPeerRequest)(nil), // 15: gateway.DisconnectInboundPeerRequest
	(*DisconnectInboundPeerReply)(nil),   // 16: gateway.DisconnectInboundPeerReply
	(*SubscriptionsRequest)(nil),         // 17: gateway.SubscriptionsRequest
	(*Subscription)(nil),                 // 18: gateway.Subscription
	(*SubscriptionsReply)(nil),           // 19: gateway.SubscriptionsReply
	(*VersionRequest)(nil),               // 20: gateway.VersionRequest
	(*VersionReply)(nil),                 // 21: gateway.VersionReply
	(*StopRequest)(nil),                  // 22: gateway.StopRequest
	(*StopReply)(nil),                    // 23: gateway.StopReply
	(*PeersRequest)(nil),                 // 24: gateway.PeersRequest
	(*RateSnapshot)(nil),                 // 25: gateway.RateSnapshot
	(*Peer)(nil),                         // 26: gateway.Peer
	(*PeersReply)(nil),                   // 27: gateway.PeersReply
	(*SendTXRequest)(nil),                // 28: gateway.SendTXRequest
	(*Transaction)(nil),                  // 29: gateway.Transaction
	(*Transactions)(nil),                 // 30: gateway.Transactions
	(*BxTransaction)(nil),                // 31: gateway.BxTransaction
	(*GetBxTransactionRequest)(nil),      // 32: gateway.GetBxTransactionRequest
	(*GetBxTransactionResponse)(nil),     // 33: gateway.GetBxTransactionResponse
	(*TxStoreRequest)(nil),               // 34: gateway.TxStoreRequest
	(*TxStoreNetworkData)(nil),           // 35: gateway.TxStoreNetworkData
	(*TxStoreReply)(nil),                 // 36: gateway.TxStoreReply
	(*TxAndSender)(nil),                  // 37: gateway.TxAndSender
	(*BlxrBatchTXRequest)(nil),           // 38: gateway.BlxrBatchTXRequest
	(*BlxrTxRequest)(nil),                // 39: gateway.BlxrTxRequest
	(*BlxrTxReply)(nil),                  // 40: gateway.BlxrTxReply
	(*TxIndex)(nil),                      // 41: gateway.TxIndex
	(*ErrorIndex)(nil),                   // 42: gateway.ErrorIndex
	(*BlxrBatchTXReply)(nil),             // 43: gateway.BlxrBatchTXReply
	(*StatusRequest)(nil),                // 44: gateway.StatusRequest
	(*AccountInfo)(nil),                  // 45: gateway.AccountInfo
	...
	(*ShortIDListRequest)(nil),           // 54: gateway.ShortIDListRequest
	(*TxListReply)(nil),                  // 55: gateway.TxListReply
	(*ShortIDsRequest)(nil),              // 56: gateway.ShortIDsRequest
	(*ShortIDsReply)(nil),                // 57: gateway.ShortIDsReply
	...
	(*ProposedBlockStatsRequest)(nil),    // 61: gateway.ProposedBlockStatsRequest
	(*ProposedBlockStatsReply)(nil),      // 62: gateway.ProposedBlockStatsReply
	(*ProposedBlockStatsRecord)(nil),     // 63: gateway.ProposedBlockStatsRecord
	nil,                                  // 64: gateway.CallParams.ParamsEntry
	nil,                                  // 65: gateway.StatusResponse.NodesEntry
	nil,                                  // 66: gateway.StatusResponse.RelaysEntry
...
var file_gateway_proto_depIdxs = []int32{
	...
	64, // 1: gateway.CallParams.params:type_name -> gateway.CallParams.ParamsEntry
	3,  // 2: gateway.EthOnBlockRequest.call_params:type_name -> gateway.CallParams
	7,  // 3: gateway.TxsReply.tx:type_name -> gateway.Tx
	67, // 4: gateway.BlocksRequest.parsedTxs:type_name -> google.protobuf.BoolValue
	11, // 5: gateway.BlocksReply.header:type_name -> gateway.BlockHeader
	12, // 6: gateway.BlocksReply.future_validator_info:type_name -> gateway.FutureValidatorInfo
	7,  // 7: gateway.BlocksReply.transaction:type_name -> gateway.Tx
	13, // 8: gateway.BlocksReply.withdrawals:type_name -> gateway.Withdrawal
	18, // 9: gateway.SubscriptionsReply.subscriptions:type_name -> gateway.Subscription
	67, // 10: gateway.Peer.initiator:type_name -> google.protobuf.BoolValue
	67, // 11: gateway.Peer.disabled:type_name -> google.protobuf.BoolValue
	25, // 12: gateway.Peer.unpaid_tx_burst_limit_excess:type_name -> gateway.RateSnapshot
	25, // 13: gateway.Peer.paid_tx_burst_limit_excess:type_name -> gateway.RateSnapshot
	25, // 14: gateway.Peer.paid_tx_throughput:type_name -> gateway.RateSnapshot
	25, // 15: gateway.Peer.unpaid_tx_throughput:type_name -> gateway.RateSnapshot
	26, // 16: gateway.PeersReply.peers:type_name -> gateway.Peer
	29, // 17: gateway.Transactions.transactions:type_name -> gateway.Transaction
	68, // 18: gateway.BxTransaction.add_time:type_name -> google.protobuf.Timestamp
	31, // 19: gateway.GetBxTransactionResponse.tx:type_name -> gateway.BxTransaction
	31, // 20: gateway.TxStoreNetworkData.oldest_tx:type_name -> gateway.BxTransaction
	35, // 21: gateway.TxStoreReply.network_data:type_name -> gateway.TxStoreNetworkData
	37, // 22: gateway.BlxrBatchTXRequest.transactions_and_senders:type_name -> gateway.TxAndSender
	41, // 23: gateway.BlxrBatchTXReply.tx_hashes:type_name -> gateway.TxIndex
	42, // 24: gateway.BlxrBatchTXReply.tx_errors:type_name -> gateway.ErrorIndex
	47, // 25: gateway.NodeConnStatus.ws_connection:type_name -> gateway.WsConnStatus
	46, // 26: gateway.NodeConnStatus.node_performance:type_name -> gateway.NodePerformance
	50, // 27: gateway.BDNConnStatus.latency:type_name -> gateway.ConnectionLatency
	51, // 28: gateway.StatusResponse.gateway_info:type_name -> gateway.GatewayInfo
	65, // 29: gateway.StatusResponse.nodes:type_name -> gateway.StatusResponse.NodesEntry
	66, // 30: gateway.StatusResponse.relays:type_name -> gateway.StatusResponse.RelaysEntry
	45, // 31: gateway.StatusResponse.account_info:type_name -> gateway.AccountInfo
	59, // 32: gateway.ProposedBlockRequest.payload:type_name -> gateway.CompressTx
	63, // 33: gateway.ProposedBlockStatsReply.records:type_name -> gateway.ProposedBlockStatsRecord
	69, // 34: gateway.ProposedBlockStatsRecord.sending_duration:type_name -> google.protobuf.Duration
	68, // 35: gateway.ProposedBlockStatsRecord.received_time:type_name -> google.protobuf.Timestamp
	68, // 36: gateway.ProposedBlockStatsRecord.sent_time:type_name -> google.protobuf.Timestamp
	48, // 37: gateway.StatusResponse.NodesEntry.value:type_name -> gateway.NodeConnStatus
	49, // 38: gateway.StatusResponse.RelaysEntry.value:type_name -> gateway.BDNConnStatus
	39, // 39: gateway.Gateway.BlxrTx:input_type -> gateway.BlxrTxRequest
	38, // 40: gateway.Gateway.BlxrBatchTX:input_type -> gateway.BlxrBatchTXRequest
	24, // 41: gateway.Gateway.Peers:input_type -> gateway.PeersRequest
	34, // 42: gateway.Gateway.TxStoreSummary:input_type -> gateway.TxStoreRequest
	32, // 43: gateway.Gateway.GetTx:input_type -> gateway.GetBxTransactionRequest
	22, // 44: gateway.Gateway.Stop:input_type -> gateway.StopRequest
	20, // 45: gateway.Gateway.Version:input_type -> gateway.VersionRequest
	44, // 46: gateway.Gateway.Status:input_type -> gateway.StatusRequest
	17, // 47: gateway.Gateway.Subscriptions:input_type -> gateway.SubscriptionsRequest
	15, // 48: gateway.Gateway.DisconnectInboundPeer:input_type -> gateway.DisconnectInboundPeerRequest
	6,  // 49: gateway.Gateway.NewTxs:input_type -> gateway.TxsRequest
	6,  // 50: gateway.Gateway.PendingTxs:input_type -> gateway.TxsRequest
	10, // 51: gateway.Gateway.NewBlocks:input_type -> gateway.BlocksRequest
	10, // 52: gateway.Gateway.BdnBlocks:input_type -> gateway.BlocksRequest
	...
	56, // 55: gateway.Gateway.ShortIDs:input_type -> gateway.ShortIDsRequest
	54, // 56: gateway.Gateway.TxsFromShortIDs:input_type -> gateway.ShortIDListRequest
	40, // 57: gateway.Gateway.BlxrTx:output_type -> gateway.BlxrTxReply
	43, // 58: gateway.Gateway.BlxrBatchTX:output_type -> gateway.BlxrBatchTXReply
	27, // 59: gateway.Gateway.Peers:output_type -> gateway.PeersReply
	36, // 60: gateway.Gateway.TxStoreSummary:output_type -> gateway.TxStoreReply
	33, // 61: gateway.Gateway.GetTx:output_type -> gateway.GetBxTransactionResponse
	23, // 62: gateway.Gateway.Stop:output_type -> gateway.StopReply
	21, // 63: gateway.Gateway.Version:output_type -> gateway.VersionReply
	52, // 64: gateway.Gateway.Status:output_type -> gateway.StatusResponse
	19, // 65: gateway.Gateway.Subscriptions:output_type -> gateway.SubscriptionsReply
	16, // 66: gateway.Gateway.DisconnectInboundPeer:output_type -> gateway.DisconnectInboundPeerReply
	9,  // 67: gateway.Gateway.NewTxs:output_type -> gateway.TxsReply
	9,  // 68: gateway.Gateway.PendingTxs:output_type -> gateway.TxsReply
	14, // 69: gateway.Gateway.NewBlocks:output_type -> gateway.BlocksReply
	14, // 70: gateway.Gateway.BdnBlocks:output_type -> gateway.BlocksReply
	...
	57, // 73: gateway.Gateway.ShortIDs:output_type -> gateway.ShortIDsReply
	55, // 74: gateway.Gateway.TxsFromShortIDs:output_type -> gateway.TxListReply
