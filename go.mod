...
require (
	...
	github.com/bloXroute-Labs/upscale-client v0.0.0-20230305080936-5cffcb5b470c
	...
	github.com/prysmaticlabs/prysm/v3 v3.2.2-rc.2
...
replace (
	...
	github.com/ethereum/go-ethereum => github.com/bloXroute-Labs/go-ethereum v1.11.1-upscale
)
