...
var (
	...
	TxTraceMaxFileSize = &cli.IntFlag{
		Name:  "txtrace-max-file-size",
		Usage: "for gateways only, sets max size of individual tx trace log file (megabytes)",
		Value: 100,
	}
	TxTraceMaxFileCount = &cli.IntFlag{
		Name:  "txtrace-max-files",
		Usage: "for gateways only, sets max number of tx trace log files stored",
		Value: 3,
	}
